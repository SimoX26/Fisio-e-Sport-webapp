...
const server = http.createServer(async (request, response) => {
  ...
  if (request.method === "GET" && requestUrl.pathname === "/api/qr") {
    ...
    writeHtml(response, 200, "<!doctype html><html><head><meta charset=\"utf-8\">"
        ...
        + "main{text-align:center}.qr{background:#fff;padding:24px;border-radius:24px;box-shadow:0 20px 50px #0002}"
        + "img{width:min(82vw,520px);height:auto;display:block}p{max-width:560px;line-height:1.45}</style></head><body><main>"
