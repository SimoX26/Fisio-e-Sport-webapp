...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/style.css?v=20260721-7">
    <script src="<%= request.getContextPath() %>/assets/js/reminder-modal.js?v=20260721-1" defer></script>
    <script src="<%= request.getContextPath() %>/assets/js/calendar.js?v=20260721-7" defer></script>
</head>
